...
class TabCompletionTest(testutils.BaseTestCase):
  ...
  def testCompletionBashScript(self):
    ...
    script = completion.bash_script(name='command', commands=commands)  # pylint: disable=protected-access
  ...
  def testCompletionFishScript(self):
    ...
    script = completion.fish_script(name='command', commands=commands)  # pylint: disable=protected-access
    self.assertIn('command', script)
    self.assertIn('halt', script)
